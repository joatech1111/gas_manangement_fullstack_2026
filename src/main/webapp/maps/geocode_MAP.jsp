...
%><%
	String mapClientId = "wysqq8sw41";
	String mapClientSecret = "CECZ0PZNTmIGnTQJNLd7wQFjbkPwIf2thzmhhoV7";
	String query = null;
	try{
		...
		if (query == null || query.trim().length() == 0) {
		    ...
		    con.setDoInput(true);
			con.setRequestProperty("X-Naver-Client-Id", mapClientId);
			con.setRequestProperty("X-Naver-Client-Secret", mapClientSecret);
