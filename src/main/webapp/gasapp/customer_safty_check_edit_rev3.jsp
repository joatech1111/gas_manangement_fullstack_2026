...
%><%
	...
	try{
		...
		if (appUser != null){
			...
			CustomerSaftyCheckMap customerSaftyChecks = null;
			...
			if (customerSaftyChecks!=null) {
				...
				if (insertMode) { // 등록 모드일 때는 최종 데이터로 초기화
					...
					if (customerSaftyCheck == null) { // 최초 안전점검이라면,
						...
						customerSaftyCheck.setAcceptable12("1");
...
<table style="width: 100% ; border: 0px solid #999999 ; border-top: 0px solid #222222 ; border-collapse: collapse;">
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " onclick="showDialogPipeLengthOptions('pageCustomerSaftyCheckEdit', 'txtPipeLength1CustomerSaftyCheckEdit')">강관</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength1CustomerSaftyCheckEdit" value="<%=pipeLength1==null?"":pipeLength1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="" /> m</td>
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " onclick="showDialogPipeLengthOptions('pageCustomerSaftyCheckEdit', 'txtPipeLength2CustomerSaftyCheckEdit')">동관</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength2CustomerSaftyCheckEdit" value="<%=pipeLength2==null?"":pipeLength2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="" /> m</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtPipeLength4CustomerSaftyCheckEdit" value="<%=pipeLength4==null?"":pipeLength4 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength5CustomerSaftyCheckEdit" value="<%=pipeLength5==null?"":pipeLength5 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> m</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " onclick="showDialogPipeLengthOptions('pageCustomerSaftyCheckEdit', 'txtValveQuantity1CustomerSaftyCheckEdit')">볼밸브</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtValveQuantity1CustomerSaftyCheckEdit" value="<%=valveQuantity1==null?"":valveQuantity1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtValveQuantity4CustomerSaftyCheckEdit" value="<%=valveQuantity4==null?"":valveQuantity4 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtEtcEquipmentName1CustomerSaftyCheckEdit" value="<%=etcEquipmentName1==null?"":etcEquipmentName1 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity1CustomerSaftyCheckEdit" value="<%=etcEquipmentQuantity1==null?"":etcEquipmentQuantity1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity2CustomerSaftyCheckEdit" value="<%=etcEquipmentQuantity2==null?"":etcEquipmentQuantity2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ;  border: 1px white ; " onclick="" /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtEtcEquipmentName3CustomerSaftyCheckEdit" value="<%=etcEquipmentName3==null?"":etcEquipmentName3 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity3CustomerSaftyCheckEdit" value="<%=etcEquipmentQuantity3==null?"":etcEquipmentQuantity3 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtEtcEquipmentName4CustomerSaftyCheckEdit" value="<%=etcEquipmentName4==null?"":etcEquipmentName4 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity4CustomerSaftyCheckEdit" value="<%=etcEquipmentQuantity4==null?"":etcEquipmentQuantity4 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ;  border: 1px white ; " onclick="" /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRange1CustomerSaftyCheckEdit" value="<%=combustorRange1==null?"":combustorRange1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRange2CustomerSaftyCheckEdit" value="<%=combustorRange2==null?"":combustorRange2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
        </td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRange3CustomerSaftyCheckEdit" value="<%=combustorRange3==null?"":combustorRange3 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorBoilerConsumptionCustomerSaftyCheckEdit" value="<%=combustorBoilerConsumption==null?"":combustorBoilerConsumption %>" maxLength="6" style="width: 50% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> kg/h</td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorEtcQuantity1CustomerSaftyCheckEdit" value="<%=combustorEtcQuantity1==null?"":combustorEtcQuantity1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorEtcQuantity2CustomerSaftyCheckEdit" value="<%=combustorEtcQuantity2==null?"":combustorEtcQuantity2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
    </tr>
	<tr style="height: 40px ; ">
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtCombustorEtcName3CustomerSaftyCheckEdit" value="<%=combustorEtcName3==null?"":combustorEtcName3 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorEtcQuantity3CustomerSaftyCheckEdit" value="<%=combustorEtcQuantity3==null?"":combustorEtcQuantity3 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtCombustorEtcName4CustomerSaftyCheckEdit" value="<%=combustorEtcName4==null?"":combustorEtcName4 %>" maxLength="6" style="width: 90% ; font-size: 14px ; border: 1px white ; " onclick=""  /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorEtcQuantity4CustomerSaftyCheckEdit" value="<%=combustorEtcQuantity4==null?"":combustorEtcQuantity4 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick=""  /> 개</td>
    </tr>
</table>
<table style="width: 100% ; border: 0px solid #999999 ; border-top: 0px solid #222222 ; border-collapse: collapse;">
	<tr>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
        	<select name="selectAcceptable12CustomerSaftyCheckEdit" id="selectAcceptable12CustomerSaftyCheckEdit"  data-role="none" data-mini="true" style="font-size: 14px ; color: blue ; " >
