...
//			String userId = appUser.getUserId();
			...
			if (signatureImage != null && signatureImage.length() > 0) {
				...
				resultCustomerSaftyCheck.setSignatureImage("");
			}
