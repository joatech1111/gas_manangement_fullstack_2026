...
<table style="width: 100% ; border: 0px solid #999999 ; border-top: 0px solid #222222 ; border-collapse: collapse;">
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength1CustomerSaftyCheckInsert" value="<%=pipeLength1==null?"":pipeLength1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()" /> m</td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtPipeLength4CustomerSaftyCheckInsert" value="<%=pipeLength4==null?"":pipeLength4 %>" maxLength="3" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength5CustomerSaftyCheckInsert" value="<%=pipeLength5==null?"":pipeLength5 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> m</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtValveQuantity1CustomerSaftyCheckInsert" value="<%=valveQuantity1==null?"":valveQuantity1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><input type="text" data-role="none" id="txtEtcEquipmentName1CustomerSaftyCheckInsert" value="<%=etcEquipmentName1==null?"":etcEquipmentName1 %>" maxLength="3" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity1CustomerSaftyCheckInsert" value="<%=etcEquipmentQuantity1==null?"":etcEquipmentQuantity1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity2CustomerSaftyCheckInsert" value="<%=etcEquipmentQuantity2==null?"":etcEquipmentQuantity2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ;  border: 1px white ; " onclick="this.select()" /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 0px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRange2CustomerSaftyCheckInsert" value="<%=combustorRange2==null?"":combustorRange2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
        </td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRange3CustomerSaftyCheckInsert" value="<%=combustorRange3==null?"":combustorRange3 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorEtcQuantity1CustomerSaftyCheckInsert" value="<%=combustorEtcQuantity1==null?"":combustorEtcQuantity1 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
