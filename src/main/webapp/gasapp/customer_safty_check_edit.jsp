...
%><%
	...
	try{
		...
		if (appUser != null){
			...
			changeEmployee = "0".equals(permission[2])?true:false;
			...
			if (customerSaftyChecks==null){
				customerSaftyChecks = BizCustomerSaftyCheck.getInstance().getCustomerSaftyChecks(serverIp, catalogName, areaCode, customerSearch.getCustomerCode(), null);
...
<table style="width: 100% ; border: 0px solid #999999 ; border-top: 0px solid #222222 ; border-collapse: collapse;">
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" rowspan="2" style="font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">배관</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength2CustomerSaftyCheckEdit" value="<%=pipeLength2==null?"":pipeLength2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()" /> m</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtPipeLength5CustomerSaftyCheckEdit" value="<%=pipeLength5==null?"":pipeLength5 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> m</td>
    </tr>
    <tr style="height: 40px ; ">
        <td colspan="2" rowspan="2" style="font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">중간<br/>밸브</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtValveQuantity2CustomerSaftyCheckEdit" value="<%=valveQuantity2==null?"":valveQuantity2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtValveQuantity5CustomerSaftyCheckEdit" value="<%=valveQuantity5==null?"":valveQuantity5 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ;  border: 1px white ; " onclick="this.select()" /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">기타</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtEtcEquipmentQuantity2CustomerSaftyCheckEdit" value="<%=etcEquipmentQuantity2==null?"":etcEquipmentQuantity2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ;  border: 1px white ; " onclick="this.select()" /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        <td rowspan="7" style="font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">연<br/>소<br/>기</td>
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRange2CustomerSaftyCheckEdit" value="<%=combustorRange2==null?"":combustorRange2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
        </td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorRangeEtcQuantityCustomerSaftyCheckEdit" value="<%=combustorRangeEtcQuantity==null?"":combustorRangeEtcQuantity %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
        	<select name="selectCombustorBoilerTypeCustomerSaftyCheckEdit" id="selectCombustorBoilerTypeCustomerSaftyCheckEdit"  data-role="none" data-mini="true" style="font-size: 14px ; color: blue ; " onchange="changeBoilerAndHeaterType()">
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtCombustorBoilerInstallerCustomerSaftyCheckEdit" value="<%=combustorBoilerInstaller==null?"":combustorBoilerInstaller %>" maxLength="5" style="width: 90% ; font-size: 14px ; border: 1px white ; "  /></td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">형식</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
        	<select name="selectCombustorHeaterTypeCustomerSaftyCheckEdit" id="selectCombustorHeaterTypeCustomerSaftyCheckEdit"  data-role="none" data-mini="true" style="font-size: 14px ; color: blue ; "  onchange="changeBoilerAndHeaterType()">
    ...
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">시공자</td>
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtCombustorHeaterInstallerCustomerSaftyCheckEdit" value="<%=combustorHeaterInstaller==null?"":combustorHeaterInstaller %>" maxLength="5" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
    </tr>
    <tr style="height: 40px ; ">
        ...
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="number" data-role="none" id="txtCombustorEtcQuantity2CustomerSaftyCheckEdit" value="<%=combustorEtcQuantity2==null?"":combustorEtcQuantity2 %>" maxLength="6" style="width: 70% ; text-align: right ; font-size: 14px ; border: 1px white ; " onclick="this.select()"  /> 개</td>
    </tr>
</table>
<table style="width: 100% ; border: 0px solid #999999 ; border-top: 0px solid #222222 ; border-collapse: collapse;">
	<tr>
    ...
    <tr>
        <td colspan="2" style="font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">점검내용</td>
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">판정</td>
    </tr>
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">가. 가스누출검사 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">나. 검사품 검사표시 유무</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">다. 중간밸브 설치여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">라. 호스 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">마. 연소기 설치규정 준수 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">바. 연소기 전용보일러실 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">사. 연소기 배기통재료 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">아. 연소기 배기통의 막힘 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">자. 용기의 옥내설치 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">차. 그 밖에 사고 유발 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td colspan="2" style="font-size:14px ; text-align: left ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">카. 권장사용기간경과 여부</td>
        <td style="width: 70px ; font-size:14px ; text-align: right ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
    ...
    <tr style="height: 40px ; ">
        <td rowspan="2" style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">개선통지사항</td>
        <td colspan="2" style="width: 70px ; font-size:14px ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtNotifyRemark1CustomerSaftyCheckEdit" value="<%=notifyRemark1==null?"":notifyRemark1 %>" maxLength="32" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
    </tr>
    <tr style="height: 40px ; ">
        <td colspan="2" style="width: 70px ; font-size:14px ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtNotifyRemark2CustomerSaftyCheckEdit" value="<%=notifyRemark2==null?"":notifyRemark2 %>" maxLength="32" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
    </tr>
    <tr style="height: 40px ; ">
        <td rowspan="2" style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; ">가스용품 교체<br />권장사항</td>
        <td colspan="2" style="width: 70px ; font-size:14px  ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtRecommendation1CustomerSaftyCheckEdit" value="<%= recommendation1==null?"":recommendation1 %>" maxLength="32" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
    </tr>
    <tr style="height: 40px ; ">
        <td colspan="2" style="width: 70px ; font-size:14px  ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " ><input type="text" data-role="none" id="txtRecommendation2CustomerSaftyCheckEdit" value="<%= recommendation2==null?"":recommendation2 %>" maxLength="32" style="width: 90% ; font-size: 14px ; border: 1px white ; " /></td>
    </tr>
    <tr style="height: 40px ; ">
        <td style="width: 70px ; font-size:14px ; text-align: center ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; "><span id="spnSignCustomerSaftyCheckEdit"><%="".equals(signatureFileName)?"서명안됨":"서명됨" %></span></td>
        <td colspan="2" style="font-size:14px  ; border-left: 1px solid #222222 ; border-right: 1px solid #222222 ; border-top: 1px solid #222222 ; border-bottom: 1px solid #222222 ; " >
        	<input id="btnSignCustomerSaftyCheckEdit" data-mini="true" type="button" value="<%="".equals(signatureFileName)?"서명등록":"서명보기" %>" data-corners="false" data-inline="true" onclick="showPageCustomerSaftyCheckSign()" />
        </td>
    </tr>
</table>
...
<%
					if (insertMode) {
%>
<input data-mini="true" type="button" value="저장" data-icon="check" data-corners="false" data-inline="true" onclick="clickSaveInsertCustomerSaftyCheckEdit(false)" ></input>
<!-- 
<input data-mini="true" type="button" value="연속등록" data-icon="plus" data-corners="false" data-inline="true" onclick="clickSaveInsertCustomerSaftyCheckEdit(true)" ></input>
 -->
<%
					} else {
%>
<input data-mini="true" type="button" value="저장" data-icon="check" data-corners="false" data-inline="true" onclick="clickSaveUpdateCustomerSaftyCheckEdit()" ></input>
