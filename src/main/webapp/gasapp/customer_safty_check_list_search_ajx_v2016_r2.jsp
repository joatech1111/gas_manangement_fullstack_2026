...
%><%
	try{
		...
		if (appUser != null){
			...
			CustomerSaftyCheckMap customerSaftyChecks = BizCustomerSaftyCheck.getInstance().getCustomerSaftyChecksRev2(serverIp, catalogName, areaCode, customerCode, null);
			session.setAttribute("CUSTOMER_SAFTY_CHECK_LIST", customerSaftyChecks);
			if (customerSaftyChecks!=null){
				out.print(customerSaftyChecks.toXML());
			}
		}else{
