...
%><%
    try {
        ...
        if (appUser != null) {
            ...
            String sequenceNumber = customerVolumeReadMeter.getSequenceNumber();
            String message = BizCustomerVolumeReadMeter.getInstance().deleteCustomerReadMeter(serverIp, catalogName, areaCode, customerCode, sequenceNumber, transactionDate, userId);
            // 거래처 거래내역 세션을 삭제
            customerVolumeReadMeters.removeCustomerVolumeReadMeter(key);
            // 거래처 정보 다시 가져오기
            String keyword = "";
