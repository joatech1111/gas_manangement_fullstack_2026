...
%><%
	try{
		...
		if (appUser != null){
			...
			// 안전점검 삭제
			BizCustomerSaftyCheck.getInstance().deleteCustomerSaftyCheckTank(serverIp, catalogName, areaCode, customerCode, sequenceNumber);
			
			// 서명 삭제
			BizCustomerSaftyCheck.getInstance().deleteCustomerSaftyCheckSignature(serverIp, catalogName, areaCode, StringUtil.convertCustomerCodeToTankFormat(customerCode), sequenceNumber);
