...
try{
	...
	if (appUser != null){
		...
		if (mobileNumber != null) mobileNumber = StringUtil.decodeBase64(mobileNumber);
		String areaName = request.getParameter("areaName");
		String employeeName = request.getParameter("employeeName");
		String userId = request.getParameter("userId");
		if (userId != null) userId = StringUtil.decodeBase64(userId);
		...
		String result = String.valueOf(BizAppUser.getInstance().appendAppUser(macNumber, "2016", mobileNumber, areaName, employeeName, userId, password, phoneAreaNumber));
