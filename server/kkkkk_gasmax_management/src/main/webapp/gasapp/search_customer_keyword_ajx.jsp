...
//			String grantCode = appUser.getMenuPermission().substring(1,2);
			...
			HashMap<String, String> pagingXML = new HashMap<String, String>(customerSearches.toPagingXML(5000));
			session.setAttribute("CUSTOMER_SEARCH_PAGING", pagingXML);

			//System.out.println("Test:" + catalogName);
			//System.out.println("xml: " + pagingXML.get("1"));
			//System.out.println("xml: " + pagingXML);
