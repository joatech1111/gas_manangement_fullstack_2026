...
public class BizAppUser {
    ...
    public AppUser getAppUser_id_pwd_uuid_areaCode(String catalogName, String id, String pwd, String uuid,
            String areaCode) {
    ...
    public AppUser getAppUser_id_pwd_uuid_dbCatalogName(String catalogName, String id, String pwd, String uuid,
            String dbCatalogName) {
        AppUserMap appUsers = selectAppUsers_idPwdUUid_dbCatalogName(catalogName, id, pwd, uuid, dbCatalogName);
        AppUser appUser = appUsers.getAppUser(uuid.toLowerCase() + "_" + dbCatalogName);

        System.out.println("getAppUser_id_pwd_uuid_dbCatalogName called with dbCatalogName: " + dbCatalogName);
        System.out.println(appUsers);
        return appUser;
    }
    ...
    public int setAppUser(
            String macNumber, String areaCode, String areaName, String employeeCode, String employeeName,
            String phoneAreaNumber, String address, String userId, String password, String menuPermission,
            String gasType) {
        HashMap<String, String> condition = new HashMap<String, String>();
        condition.put("macNumber", macNumber);
    ...
    public int setAppUser(
            String macNumber, String areaSeq, String areaCode, String areaName, String employeeCode,
            String employeeName, String phoneAreaNumber, String address, String userId, String password,
            String menuPermission, String gasType) {
        HashMap<String, String> condition = new HashMap<String, String>();
        condition.put("macNumber", macNumber);
        condition.put("areaSeq", areaSeq);
        condition.put("areaCode", areaCode);
     ...
     */
    public String appendAppUser(String macNumber, String phoneModel, String mobileNumber, String areaName,
            String employeeName, String userId, String password, String phoneAreaNumber)
    ...
    public String insertAppUser(HashMap<String, Object> param) throws JdbcIOException, JdbcProcedureException {
        return JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG).executeProcedure("GASMAX.AppUser.Insert", param,
                "outputMessage"); // 처리 결과 메시지를 반환
    }
    ...
    public AppUserMap selectAppUsers(String catalogName) {
        try {
            ...
            List<HashMap> list = JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG).selectQuery("GASMAX.AppUser.Select",
                    condition);
    ...
    public AppUserMap selectAppUsers_idPwd(String catalogName, String userId, String password) {
        try {
            ...
            condition.put("password", password);
            @SuppressWarnings("rawtypes")
            List<HashMap> list = JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG)
                    .selectQuery("GASMAX.AppUser.Select_userIdPwd", condition);
            for (HashMap<String, String> map : list) {
                AppUser appUser = convertAppUser(map);
                appUsers.setAppUser(appUser.getKeyValue(), appUser);
            }
    ...
    public AppUserMap selectAppUsers_idPwdUUid(String catalogName, String userId, String password, String uuid) {
        try {
            ...
            @SuppressWarnings("rawtypes")
            List<HashMap> list = JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG)
                    .selectQuery("GASMAX.AppUser.Select_userIdPwdUUid", condition);
            for (HashMap<String, String> map : list) {
                AppUser appUser = convertAppUser(map);
                appUsers.setAppUser(appUser.getKeyValue(), appUser);
            }
    ...
    public AppUserMap selectAppUsers_idPwdUUid_areaCode(String catalogName, String userId, String password, String uuid,
            String areaCode) {
        try {
            AppUserMap appUsers = new AppUserMap();
            HashMap<String, String> condition = new HashMap<String, String>();
            ...
            @SuppressWarnings("rawtypes")
            List<HashMap> list = JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG)
                    .selectQuery("GASMAX.AppUser.Select_userIdPwdUUid_areaCode", condition);
            for (HashMap<String, String> map : list) {
                AppUser appUser = convertAppUser(map);
    ...
    public AppUserMap selectAppUsers_idPwdUUid_dbCatalogName(String catalogName, String userId, String password,
            String uuid, String dbCatalogName) {
        try {
            AppUserMap appUsers = new AppUserMap();
            HashMap<String, String> condition = new HashMap<String, String>();
            condition.put("catalogName", catalogName);
            ...
            condition.put("password", password);
            condition.put("uuid", uuid);
            condition.put("dbCatalogName", dbCatalogName);
            @SuppressWarnings("rawtypes")
            List<HashMap> list = JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG)
                    .selectQuery("GASMAX.AppUser.Select_userIdPwdUUid_dbCatalogName", condition);
            for (HashMap<String, String> map : list) {
                AppUser appUser = convertAppUser(map);
                appUsers.setAppUser(appUser.getKeyValue() + "_" + dbCatalogName, appUser);
            }
            return appUsers;
        } catch (Exception e) {
            System.out.println("Error in selectAppUsers_idPwdUUid_dbCatalogName: " + e.getMessage());
            e.printStackTrace();
        }
        return null;
    }
    ...
    protected AppUserMap selectMultiAppUsers(String catalogName, String macNumber) {
        try {
            ...
            @SuppressWarnings("rawtypes")
            List<HashMap> list = JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG)
                    .selectQuery("GASMAX.MultiAppUser.Select", condition);
            for (HashMap<String, String> map : list) {
                AppUser appUser = convertAppUser(map);
    ...
    public LinkedHashMap<String, String> selectPhoneAreaNumbers(String serverIp, String catalogName) {
        ...
        @SuppressWarnings("rawtypes")
        List<HashMap> list = JdbcUtil.getInstance(serverIp).selectQuery(GASMAX_APP_USER_SELECT_PHONE_AREA_NUMBER_ID,
                condition);
        for (HashMap<String, String> map : list) {
    ...
    protected int updateLatestLoginDate(HashMap<String, String> condition) {
        return JdbcUtil.getInstance(JdbcUtil.DEFAULT_SQL_CONFIG).updateQuery("GASMAX.AppUser.UpdateLatestLoginDate",
                condition);
    }
    ...
    public static void main(String[] args) {
        try {
            ...
            // String message = bizAppUser.appendAppUser(macNumber, phoneModel,
            // mobileNumber, areaName, employeeName, userId, password, phoneAreaNumber);
            // System.out.println(message);
            // AppUserMap appUsers =
            // BizAppUser.getInstance().getAppUsers(BizAppUser.DEFAULT_APP_USER_CATATLOG_NAME);
            // System.out.println(appUsers.toXML());
            //
            // AppUser appUser =
            // BizAppUser.getInstance().getAppUser(BizAppUser.DEFAULT_APP_USER_CATATLOG_NAME,
            // "356455042867040");
