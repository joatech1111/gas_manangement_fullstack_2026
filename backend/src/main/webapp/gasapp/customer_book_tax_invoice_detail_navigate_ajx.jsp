...
%><%
	try{
		...
		CustomerTaxInvoiceMap taxInvoices = (CustomerTaxInvoiceMap)session.getAttribute("CUSTOMER_BOOK_TAX_INVOICE");
		if (taxInvoices != null){
			java.util.Iterator<String> iterator = taxInvoices.getCustomerTaxInvoices().keySet().iterator();
			String priorKey = "X";
			String id = "X";
